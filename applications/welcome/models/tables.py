...
db.define_table('bulletin_boards',
                ...
                Field('board_id'),
                Field('loading_board', 'boolean', default=True)
                )
...
db.define_table('posts',
                ...
                Field('post_id'),
                Field('marked_for_delete', 'boolean', default=False),
                Field('loading_post', 'boolean', default=True)
                )
